        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal" maxWidth="sm">
            ...
            <div class="p-6">
                ...
                <template v-if="hasPassword">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Setelah akun dihapus, semua datanya akan lenyap secara permanen. Masukkan password Anda untuk mengonfirmasi.
                    </p>
                ...
                <template v-else>
                    <div class="text-center pt-2 pb-4">
                        ...
                        <p class="mt-2 text-sm text-gray-600">
                            Apakah anda yakin hapus akun anda saat ini? Tindakan ini tidak dapat dibatalkan.
                        </p>
                    </div>
                </template>

                <!-- Tombol aksi (kecil) -->
                <div class="mt-6 flex justify-end gap-3" :class="{ 'justify-center': !hasPassword }">
