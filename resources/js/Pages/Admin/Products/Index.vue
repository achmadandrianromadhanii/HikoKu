    ...
    defineOptions({
        layout: (h, page) =>
            h(
                ...
                {
                    title: 'Kelola Produk',
                    subtitle: 'Atur dan publikasikan katalog produk Anda ke pengguna.',
                },
                () => page
            ),
    });
...
<template>
        ...
        >
            ...
            <div class="flex-1">
                ...
                <p class="text-xs font-medium mt-1 opacity-90">
                    Terdapat {{ lowStockAlerts.length }} produk yang stoknya habis atau tersisa 1.
                    Harap segera periksa dan tambah stok.
                </p>
                            ...
                            >
                                ...
                                <div class="max-h-64 overflow-y-auto p-1">
                                    ...
                                    >
                                        ...
                                        <ChevronRight
                                            class="h-4 w-4 text-slate-300 group-hover:text-cyan-500 transition-colors"
                                        />
                                    </Link>
                                </div>
                                <div
                ...
                <table class="w-full text-left text-sm text-slate-600 whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-slate-50/50">
                            ...
                            <td colspan="6" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center gap-3">
                                    ...
                                    <p class="text-xs text-slate-500">
                                        Coba sesuaikan kata kunci atau hapus filter Anda.
                                    </p>
                                </div>
                            </td>
                        </tr>
                        ...
                        >
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="relative shrink-0">
                                        ...
                                        <div
                                            v-else
                                            :class="[
                                                'flex h-10 w-10 items-center justify-center rounded-[14px] text-xs font-black tracking-tight shadow-sm border border-white/50',
                                                getGradient(row.id),
                                            ]"
                                        >
                                            {{ getInitials(row.name) }}
                            ...
                            <td class="px-6 py-3">
                                <span
                                    class="inline-flex items-center text-[12px] font-medium text-slate-600 bg-slate-50 px-2 py-1 rounded-md"
                                >
                                    {{ row.category_name }}
                                </span>
                            </td>
                            ...
                            <td
                                class="px-6 py-3 text-right tabular-nums font-bold text-[13px] text-slate-700"
                            >
                                {{ row.price_label }}
                            </td>
                            ...
                            <td class="px-6 py-3 text-center">
                                <div class="flex flex-col items-center">
                                    <span
                                        class="tabular-nums font-bold text-[13px]"
                                        :class="
                            ...
                            <td class="px-6 py-3">
                                <div class="flex flex-wrap items-center gap-1.5">
                                    ...
                                    <span
                                        ...
                                        class="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-amber-50 text-amber-600 border border-amber-100/50"
                                    >
                                        ⭐ Top
                                    </span>
                                </div>
    ...
    <ConfirmModal
        ...
        title="Hapus Produk"
        message="Yakin ingin menghapus produk ini secara permanen dari sistem?"
