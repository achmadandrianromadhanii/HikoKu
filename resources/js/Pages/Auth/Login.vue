    ...
    <AuthLayout title="Form Login">
        ...
        <div class="mx-auto flex min-h-[100dvh] w-full max-w-[420px] items-center justify-center px-4 py-2 sm:px-6 lg:px-8">
            ...
            <section class="w-full rounded-[32px] border border-white/10 bg-[#0B1120]/90 backdrop-blur-2xl px-5 py-5 shadow-[0_20px_60px_rgba(0,0,0,0.6)] sm:px-8 sm:py-8 relative overflow-hidden">
                ...
                <div class="absolute -top-16 -left-16 h-40 w-40 rounded-full bg-cyan-500/20 blur-3xl pointer-events-none"></div>
                <div class="absolute -bottom-16 -right-16 h-40 w-40 rounded-full bg-emerald-500/10 blur-3xl pointer-events-none"></div>
