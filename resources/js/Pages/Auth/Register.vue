<script setup>
    ...
    import { User, Mail, Phone, LockKeyhole, Eye, EyeOff, LoaderCircle } from 'lucide-vue-next';
...
<template>
    ...
    <AuthLayout title="Form Register">
        ...
        <div
            class="mx-auto flex min-h-[100dvh] w-full max-w-[420px] items-center justify-center px-4 py-4 sm:px-6 lg:px-8"
        >
            ...
            >
                ...
                <div
                    class="absolute -top-16 -right-16 h-40 w-40 rounded-full pointer-events-none"
                    style="
                ...
                ></div>
                <div
                    class="absolute -bottom-16 -left-16 h-40 w-40 rounded-full pointer-events-none"
                    style="
                        background: radial-gradient(
                            circle,
                ...
                <form class="space-y-3 relative z-10" @submit.prevent="submit">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <div class="group relative z-0 w-full">
                                ...
                                <span
                                    class="pointer-events-none absolute left-3 top-2.5 text-slate-500 transition-colors peer-focus:text-cyan-400"
                                >
                                    <User class="h-4 w-4" />
                                </span>
                            ...
                            <p
                                ...
                                class="mt-1 pl-1 text-[10px] font-bold text-rose-400"
                            >
                                {{ form.errors.name }}
                            </p>
                        </div>
                    ...
                    <div class="flex items-center justify-center gap-4 pt-0">
                        ...
                        <!-- GitHub -->
                        <a
                            v-if="githubRegisterUrl"
                            :href="githubRegisterUrl"
                            class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 shadow-lg backdrop-blur-md transition-all hover:scale-110 hover:border-white/20 hover:bg-white/10 active:scale-95"
                        ...
                        <!-- Discord -->
                        <a
                            v-if="discordRegisterUrl"
                            :href="discordRegisterUrl"
