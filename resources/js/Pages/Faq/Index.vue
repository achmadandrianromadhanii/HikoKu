        ...
        <div class="block">
            ...
            <section class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
                <div class="mb-12 text-center">
                    ...
                    <h1 class="user-page-title drop-shadow-sm">
                        Pertanyaan yang sering ditanyakan
                    </h1>
                    <p class="user-page-desc mx-auto max-w-xl text-slate-500">
                        Temukan jawaban cepat seputar proses rental, pembayaran, stok, dan
                        pengambilan barang.
                    </p>
                </div>
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center gap-4">
                                ...
                                <div
                                    class="flex shrink-0 items-center justify-center text-cyan-500 drop-shadow-[0_0_8px_rgba(6,182,212,0.3)] transition-transform duration-300 group-hover:scale-110"
                                >
                        ...
                        <transition name="slide-fade">
                            <div v-if="openId === faq.id">
                                ...
                                <div
                                    class="border-t border-slate-100/50 px-6 pb-6 pt-4 text-[13.5px] leading-relaxed text-slate-500 bg-white/30"
                                >
                                    {{ faq.answer }}
                                </div>
                            </div>
                ...
                >
                    ...
                    <p class="mt-2 text-[13px] text-slate-500 max-w-sm mx-auto">
                        Pertanyaan yang sering diajukan akan tampil di halaman ini segera setelah
